<script>
// Firebase disabled for local admin preview. Using stub auth.
const auth = {
  currentUser: { uid: 'local-admin', email: 'admin@local' },
  signIn: function(){ return Promise.resolve(this.currentUser); }
};
// Use auth.signIn() in place of firebase auth for local testing.
</script>
// [firebase removed for local dev - stubbed]
import {
  getFirestore,
  collection,
  addDoc,
